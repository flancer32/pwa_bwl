 ...
 *
 * @namespace Fl32_Bwl_Front_Door_Pub_Route_Friends_Add
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Front_Door_Pub_Route_Friends_Add';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @memberOf Fl32_Bwl_Front_Door_Pub_Route_Friends_Add
 * @returns {Fl32_Bwl_Front_Door_Pub_Route_Friends_Add.vueCompTmpl}
 */
