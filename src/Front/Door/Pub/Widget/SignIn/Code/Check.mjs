 ...
 *
 * @namespace Fl32_Bwl_Front_Door_Pub_Widget_SignIn_Code_Check
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Front_Door_Pub_Widget_SignIn_Code_Check';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @memberOf Fl32_Bwl_Front_Door_Pub_Widget_SignIn_Code_Check
 * @returns {Fl32_Bwl_Front_Door_Pub_Widget_SignIn_Code_Check.vueCompTmpl}
 */
