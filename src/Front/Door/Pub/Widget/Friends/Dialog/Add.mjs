 ...
 *
 * @namespace Fl32_Bwl_Front_Door_Pub_Widget_Friends_Dialog_Add
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Front_Door_Pub_Widget_Friends_Dialog_Add';
 ...
 *
 * @memberOf Fl32_Bwl_Front_Door_Pub_Widget_Friends_Dialog_Add
 * @returns {Fl32_Bwl_Front_Door_Pub_Widget_Friends_Dialog_Add.vueCompTmpl}
 */
