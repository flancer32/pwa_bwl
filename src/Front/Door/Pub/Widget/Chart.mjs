 ...
 *
 * @namespace Fl32_Bwl_Front_Door_Pub_Widget_Chart
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Front_Door_Pub_Widget_Chart';
const DOM_ID_CHART = 'appChartWidget';

// MODULE'S CLASSES
/**
 *
 * @memberOf Fl32_Bwl_Front_Door_Pub_Widget_Chart
 */
class ChartData {
    /** @type {number|null} */
    target;
 ...
 *
 * @memberOf Fl32_Bwl_Front_Door_Pub_Widget_Chart
 * @returns {Fl32_Bwl_Front_Door_Pub_Widget_Chart.vueCompTmpl}
 */
