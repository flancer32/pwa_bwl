 ...
 *
 * @namespace Fl32_Bwl_Front_Widget_Scroller_Vertical
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Front_Widget_Scroller_Vertical';
 ...
 *
 * @memberOf Fl32_Bwl_Front_Widget_Scroller_Vertical
 * @returns {Fl32_Bwl_Front_Widget_Scroller_Vertical.vueCompTmpl}
 */
function Factory(spec) {
    /** @type {typeof Fl32_Bwl_Front_On_Touch} */
    const OnTouch = spec['Fl32_Bwl_Front_On_Touch#'];
