 ...
 *
 * @namespace Fl32_Bwl_Shared_WAPI_Sign_Up
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Shared_WAPI_Sign_Up';

// MODULE'S CLASSES
/**
 * @memberOf Fl32_Bwl_Shared_WAPI_Sign_Up
 */
class Request {
    /** @type {number} */
    age;
...
class Factory {
    constructor(spec) {
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Sign_Up.Request}
         */
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Sign_Up.Response}
         */
