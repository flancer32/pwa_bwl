 ...
 *
 * @namespace Fl32_Bwl_Shared_WAPI_Friend_Link_Add
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Shared_WAPI_Friend_Link_Add';

// MODULE'S CLASSES
/**
 * @memberOf Fl32_Bwl_Shared_WAPI_Friend_Link_Add
 */
class Request {
    /** @type {string} */
    code;
...
class Factory {
    constructor(spec) {
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Friend_Link_Add.Request}
         */
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Friend_Link_Add.Response}
         */
