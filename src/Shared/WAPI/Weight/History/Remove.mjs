 ...
 *
 * @namespace Fl32_Bwl_Shared_WAPI_Weight_History_Remove
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Shared_WAPI_Weight_History_Remove';

// MODULE'S CLASSES
/**
 * @memberOf Fl32_Bwl_Shared_WAPI_Weight_History_Remove
 */
class Request {
    /** @type {Date} */
    date;
...
class Factory {
    constructor(spec) {
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Weight_History_Remove.Request}
         */
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Weight_History_Remove.Response}
         */
