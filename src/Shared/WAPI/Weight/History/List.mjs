 ...
 *
 * @namespace Fl32_Bwl_Shared_WAPI_Weight_History_List
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Shared_WAPI_Weight_History_List';

// MODULE'S CLASSES
/**
 * @memberOf Fl32_Bwl_Shared_WAPI_Weight_History_List
 */
class Request {
    /** @type {Date} */
    dateFrom;
 ...
 */
class Response {
    /** @type {Fl32_Bwl_Shared_Dto_Weight_History_Item[]} */
    items;
}
...
class Factory {
    constructor(spec) {
        ...
        /** @type {typeof Fl32_Bwl_Shared_Dto_Weight_History_Item} */
        const DItem = spec['Fl32_Bwl_Shared_Dto_Weight_History_Item#'];
        /** @type {Fl32_Bwl_Shared_Dto_Weight_History_Item.Factory} */
        const fItem = spec['Fl32_Bwl_Shared_Dto_Weight_History_Item#Factory$'];
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Weight_History_List.Request}
         */
         ...
         * @return {Fl32_Bwl_Shared_WAPI_Weight_History_List.Response}
         */
