 ...
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Shared_Service_Dto_Profile';

// MODULE'S CLASSES
class Fl32_Bwl_Shared_Service_Dto_Profile {
    /** @type {number} */
    age;
    /** @type {Date} */
    dateUpdated;
...
Fl32_Bwl_Shared_Service_Dto_Profile.AGE = 'age';
Fl32_Bwl_Shared_Service_Dto_Profile.DATE_UPDATED = 'dateUpdated';
Fl32_Bwl_Shared_Service_Dto_Profile.HEIGHT = 'height';
 ...
 * @memberOf Fl32_Bwl_Shared_Service_Dto_Profile
 */
class Factory {
    constructor() {
        /**
         * @param {Fl32_Bwl_Shared_Service_Dto_Profile|null} data
         * @return {Fl32_Bwl_Shared_Service_Dto_Profile}
         */
        this.create = function (data = null) {
            const res = new Fl32_Bwl_Shared_Service_Dto_Profile();
            res.age = data?.age;
