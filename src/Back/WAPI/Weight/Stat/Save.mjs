 ...
 *
 * @namespace Fl32_Bwl_Back_WAPI_Weight_Stat_Save
 */
// MODULE'S IMPORT
import {constants as H2} from 'http2';

// MODULE'S VARS
const NS = 'Fl32_Bwl_Back_WAPI_Weight_Stat_Save';

/**
 * @implements TeqFw_Web_Back_Api_WAPI_IFactory
 */
export default class Fl32_Bwl_Back_WAPI_Weight_Stat_Save {
    ...
    constructor(spec) {
        ...
        const TYPE_FRONT = spec['Fl32_Bwl_Shared_WAPI_Weight_Stat_Save#TYPES'];
        ...
        this.getService = function () {
            ...
            async function service(context) {
                /** @type {Fl32_Bwl_Shared_WAPI_Weight_Stat_Save.Request} */
                const req = context.getInData();
                // /** @type {Fl32_Bwl_Shared_WAPI_Weight_Stat_Save.Response} */
