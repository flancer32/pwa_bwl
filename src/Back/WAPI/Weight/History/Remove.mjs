 ...
 *
 * @namespace Fl32_Bwl_Back_WAPI_Weight_History_Remove
 */
// MODULE'S IMPORT
import {constants as H2} from 'http2';

// MODULE'S VARS
const NS = 'Fl32_Bwl_Back_WAPI_Weight_History_Remove';

/**
 * @implements TeqFw_Web_Back_Api_WAPI_IFactory
 */
export default class Fl32_Bwl_Back_WAPI_Weight_History_Remove {
    ...
    constructor(spec) {
        ...
        const route = spec['Fl32_Bwl_Shared_WAPI_Weight_History_Remove#Factory$'];
        ...
        this.getService = function () {
            ...
            async function service(context) {
                /** @type {Fl32_Bwl_Shared_WAPI_Weight_History_Remove.Request} */
                const req = context.getInData();
                /** @type {Fl32_Bwl_Shared_WAPI_Weight_History_Remove.Response} */
