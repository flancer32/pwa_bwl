 ...
 *
 * @namespace Fl32_Bwl_Back_WAPI_Weight_History_List
 */
import {constants as H2} from 'http2';

// MODULE'S VARS
const NS = 'Fl32_Bwl_Back_WAPI_Weight_History_List';

/**
 * @implements TeqFw_Web_Back_Api_WAPI_IFactory
 */
export default class Fl32_Bwl_Back_WAPI_Weight_History_List {
    ...
    constructor(spec) {
        ...
        const DWeightItem = spec['Fl32_Bwl_Shared_Dto_Weight_History_Item#'];
        ...
        const route = spec['Fl32_Bwl_Shared_WAPI_Weight_History_List#Factory$'];
        ...
        this.getService = function () {
            ...
            async function service(context) {
                 ...
                 * @param {Fl32_Bwl_Shared_WAPI_Weight_History_List.Request} apiReq
                 * @return {Promise<*[]>}
                 */
                ...
                // MAIN FUNCTIONALITY
                /** @type {Fl32_Bwl_Shared_WAPI_Weight_History_List.Request} */
