 ...
 *
 * @namespace Fl32_Bwl_Back_WAPI_Friend_Link_Code_Create
 */
// MODULE'S IMPORT
import {constants as H2} from 'http2';

// MODULE'S VARS
const NS = 'Fl32_Bwl_Back_WAPI_Friend_Link_Code_Create';

/**
 * @implements TeqFw_Web_Back_Api_WAPI_IFactory
 */
export default class Fl32_Bwl_Back_WAPI_Friend_Link_Code_Create {
    ...
    constructor(spec) {
        ...
        const route = spec['Fl32_Bwl_Shared_WAPI_Friend_Link_Code_Create#Factory$'];
        ...
        this.getService = function () {
            ...
            async function service(context) {
                ...
                // MAIN FUNCTIONALITY
                /** @type {Fl32_Bwl_Shared_WAPI_Friend_Link_Code_Create.Request} */
