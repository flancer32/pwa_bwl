 ...
 *
 * @namespace Fl32_Bwl_Back_WAPI_Profile_Get
 */
// MODULE'S IMPORT
import {constants as H2} from 'http2';

// MODULE'S VARS
const NS = 'Fl32_Bwl_Back_WAPI_Profile_Get';

/**
 * @implements TeqFw_Web_Back_Api_WAPI_IFactory
 */
export default class Fl32_Bwl_Back_WAPI_Profile_Get {
    ...
    constructor(spec) {
        ...
        this.getService = function () {
            ...
            async function service(context) {
                 ...
                 * @param {number} userId
                 * @returns {Promise<Fl32_Bwl_Shared_Dto_Profile>} UI compatible DTO
                 */
                ...
                // MAIN FUNCTIONALITY
                /** @type {Fl32_Bwl_Shared_WAPI_Profile_Get.Request} */
