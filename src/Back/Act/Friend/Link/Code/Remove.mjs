 ...
 *
 * @namespace Fl32_Bwl_Back_Act_Friend_Link_Code_Remove
 */
// MODULE'S VARS
const NS = 'Fl32_Bwl_Back_Act_Friend_Link_Code_Remove';
 ...
 * @constructs Fl32_Bwl_Back_Act_Friend_Link_Code_Remove.process
